...
export const PhotoUploader: React.FC<PhotoUploaderProps> = ({ onImageUpload, previewUrl }) => {
  ...
  return (
    <div
      className={`relative w-full aspect-[4/3] border-2 border-dashed rounded-lg flex items-center justify-center text-center p-4 cursor-pointer transition-colors ${
        isDraggingOver 
